...
\begin{figure}[!ht]
    ...
    %     \label{fig: NTR_3d_iid_with_consumption_time}
    % \end{subfigure}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[scale = 0.45]{NTR_4D_Projection_proj_2_3_4.png}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[scale = 0.45]{NTR_4D_Projection_proj_1_3_4.png}
        \caption{No Trade Region for Shober parameters, projected to asset 1,3,4.}        % \label{fig:NTR_2d_high_correlation_with_consumption_over_time}
    \end{subfigure}
    % \vspace{1em}
    % \begin{subfigure}[t]{0.48\textwidth}
    %     \centering
