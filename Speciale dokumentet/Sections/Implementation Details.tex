...
\begin{enumerate}
  \item Sample points outside the \ac{NTR} in the general state space. For this i can use a uniform grid, or a random grid. I then remove all points inside the \ac{NTR}, and resample until i have enough points.
...
This is done after having optimized over the $N$ points from the sampling strategy, i construct two datasets and two \ac{GPR}s:
\begin{align}
