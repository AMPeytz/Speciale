...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.475\textwidth]{../Sections/tikzfigure.pdf} % Path to your PDF file
  \caption{Schematic of the No-Trade Region}
  \label{fig:no_trade_region_schematic}
  % add float foot
  \floatfoot{This figure is a recreation of Figure 1. in \textcite{Scheidegger2023}.}
\end{figure}
\FloatBarrier
